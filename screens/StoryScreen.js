          ...
          <View style={styles.storyContainer}>
            ...
            >
                ...
                <View style={styles.iconContainer}>
                  <TouchableOpacity
                    onPress={() =>
                      this.initiateTTS(
                        this.props.route.params.story.value.title,
                        this.props.route.params.story.value.description,
              ...
              <Text
                ...
                >
                2 to 3 -  {this.props.route.params.story.value.description}
                </Text>
                <Text
                  style={
                    this.state.light_theme
                ...
                >
                3 to 4 -  {this.props.route.params.story.value.story}
                </Text>
                <Text
                  style={
                    this.state.light_theme
                ...
                >
                  4 to 5 -  {this.props.route.params.story.value.moral}
                </Text>
              </View>
